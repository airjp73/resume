...
<section id="summary">
  Frontend software engineer with strong fundamentals and close to 6 years of
  professional experience using React. Thrive in an environment with tough
  technical challenges and not afraid to dig into hard data to figure out what's
  working for the customer and what isn't. Highly collaborative and accustomed
  to working with designers, product managers, and other engineering teams to
  meet the needs of the customer. Believe that it's important to be a multiplier
  -- achieving the biggest impact through helping others grow and succeed, in
  addition to doing your own best work.
</section>
...
- Overhauled the company's frontend unit testing methodology, reducing the number of regressions that made it to production
